 ...
 *
 * Note: P3 cleanup removed the IM/OT-related tables (project_bindings,
 * sync_file_snapshots, pending_ops, assistant_conversation_bindings). They
 * remain in existing user DBs as inert artifacts — sqlite ignores unknown
 * tables. Future installs simply won't create them.
 */
